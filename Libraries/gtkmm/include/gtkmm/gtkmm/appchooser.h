...
typedef struct _GtkAppChooserClass GtkAppChooserClass;
#endif /* DOXYGEN_SHOULD_SKIP_THIS */
...
public:
  ...
  typedef AppChooser_Class CppClassType;
...
private:
  ...
  // noncopyable
  AppChooser(const AppChooser&);
  AppChooser& operator=(const AppChooser&);
...
public:
   ...
   * @newin{3,0}
   * 
   * @return A AppInfo for the currently selected
   * application, or <tt>0</tt> if none is selected. Free with Glib::object_unref().
   */
   ...
   * @newin{3,0}
   * 
   * @return The content type of @a self. Free with Glib::free().
   */
