...
public:
  ...
  typedef GestureZoom_Class CppClassType;
...
private:
  // noncopyable
  GestureZoom(const GestureZoom&);
  GestureZoom& operator=(const GestureZoom&);
...
public:
  ...
  Glib::SignalProxy1< void,double > signal_scale_changed();
