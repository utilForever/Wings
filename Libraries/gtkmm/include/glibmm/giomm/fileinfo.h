...
public:
   ...
   * against or <tt>0</tt> if @a matcher was <tt>0</tt>.
   */
...
public:
   ...
   * types for the given @a name_space, or <tt>0</tt> on error.
   */
   ...
   * FILE_ATTRIBUTE_TYPE_INVALID if the key is not set.
   */
   ...
   * FILE_ATTRIBUTE_STATUS_UNSET if the key is invalid.
   */
   ...
   * not contain a stringv, <tt>0</tt> will be returned.
   * 
   * @newin{2,22}
   * 
   * @param attribute A file attribute key.
   * @return The contents of the @a attribute value as a stringv, or
   * <tt>0</tt> otherwise. Do not free. These returned strings are UTF-8.
   */
   ...
   * 
   * @param attribute A file attribute key.
   * @param attr_value A <tt>0</tt> terminated array of UTF-8 strings.
   */
   ...
   * G_FILE_ATTRIBUTE_TRASH_DELETION_DATE attribute is unset, <tt>0</tt> is returned.
   * 
   * @newin{2,36}
   * 
