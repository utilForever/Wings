...
public:
  ...
  virtual ~ApplicationCommandLine() noexcept;
...
public:
   ...
   * UTF-8 on Windows.
   * 
   * If you wish to use the return value with OptionContext, you must
   * use Glib::option_context_parse_strv().
   * 
   ...
   * you don't need to check for <tt>0</tt>.
   * 
   * @newin{2,40}
   * 
   ...
   * If stdin is not available then <tt>0</tt> will be returned.  In the
