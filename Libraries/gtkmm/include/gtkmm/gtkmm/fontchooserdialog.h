...
#ifndef DOXYGEN_SHOULD_SKIP_THIS
namespace Gtk
{ class FontChooserDialog_Class; } // namespace Gtk
#endif //DOXYGEN_SHOULD_SKIP_THIS
...
private:
  friend class FontChooserDialog_Class;
  static CppClassType fontchooserdialog_class_;

  // noncopyable
  FontChooserDialog(const FontChooserDialog&);
  FontChooserDialog& operator=(const FontChooserDialog&);
