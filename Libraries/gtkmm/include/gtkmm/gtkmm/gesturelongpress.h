...
public:
  typedef GestureLongPress CppObjectType;
  typedef GestureLongPress_Class CppClassType;
  typedef GtkGestureLongPress BaseObjectType;
  typedef GtkGestureLongPressClass BaseClassType;
...
private:
  // noncopyable
  GestureLongPress(const GestureLongPress&);
  GestureLongPress& operator=(const GestureLongPress&);
...
public:
  ...
  Glib::SignalProxy2< void,double,double > signal_pressed();
   ...
   * before Gtk::GestureLongPress::property_pressed() happened.
   * 
   * @newin{3,14}
   * 
   */
