...
private:
  ...
  Actionable& operator=(const Actionable&);
...
public:
   ...
   * @newin{3,4}
   * 
   * @return The action name, or <tt>0</tt> if none is set.
   */
  Glib::ustring get_action_name() const;
  
  /** Specifies the name of the action with which this widget should be
   * associated.  If @a action_name is <tt>0</tt> then the widget will be
   ...
   * @newin{3,4}
   * 
   * @param action_name An action name, or <tt>0</tt>.
   */
   ...
   * 
   * If @a target_value is <tt>0</tt> then the target value is unset.
   * 
   ...
   * @newin{3,4}
   * 
   * @param target_value A Variant to set as the target value, or <tt>0</tt>.
   */
