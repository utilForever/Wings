...
#ifndef _GOOCANVASMM_WIDGET_H
#define _GOOCANVASMM_WIDGET_H
...
namespace Goocanvas
{ class Widget_Class; } // namespace Goocanvas
namespace Goocanvas
{


class Widget : public Goocanvas::ItemSimple
{
...
public:
  ...
  typedef GooCanvasWidget BaseObjectType;
  typedef GooCanvasWidgetClass BaseClassType;

private:  friend class Widget_Class;
...
protected:
  ...
  explicit Widget(GooCanvasWidget* castitem);
...
public:
  ...
  GooCanvasWidget*       gobj()       { return reinterpret_cast<GooCanvasWidget*>(gobject_); }

  ///Provides access to the underlying C GObject.
  const GooCanvasWidget* gobj() const { return reinterpret_cast<GooCanvasWidget*>(gobject_); }
