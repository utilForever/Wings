...
class TlsCertificate_Class : public Glib::Class
{
public:
...
protected:
  ...
  static GTlsCertificateFlags verify_vfunc_callback(GTlsCertificate* self, GSocketConnectable* identity, GTlsCertificate* trusted_ca);
};
