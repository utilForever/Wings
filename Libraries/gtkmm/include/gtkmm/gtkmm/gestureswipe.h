...
public:
  typedef GestureSwipe CppObjectType;
  typedef GestureSwipe_Class CppClassType;
  typedef GtkGestureSwipe BaseObjectType;
  typedef GtkGestureSwipeClass BaseClassType;
...
private:
  // noncopyable
  GestureSwipe(const GestureSwipe&);
  GestureSwipe& operator=(const GestureSwipe&);
...
public:
  ...
  Glib::SignalProxy2< void,double,double > signal_swipe();
