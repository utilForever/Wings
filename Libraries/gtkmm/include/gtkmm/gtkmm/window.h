...
/** The widget where the window is attached.
  ...
  /** Returns the default widget for @a window. See set_default()
   * for more details.
   * 
   * @newin{2,14}
   * 
   * @return The default widget, or <tt>0</tt> if there is none.
   */
   ...
   * `g_list_foreach (result, (GFunc)g_object_ref, <tt>0</tt>)` first, and
