...
public:
   ...
   * 
   * @return A Drive or <tt>0</tt> if @a volume is not
   ...
   * or <tt>0</tt>. Use Glib::object_unref() to free.
   */
   ...
   * @newin{2,32}
   * 
   * @return Sorting key for @a volume or <tt>0</tt> if no such key is available.
   */
