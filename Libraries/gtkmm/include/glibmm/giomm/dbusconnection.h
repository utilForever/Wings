...
public:
   ...
   * to g_bus_get().
   * @return A DBusConnection or <tt>0</tt> if @a error is set.
   ...
   * @return A DBusConnection or <tt>0</tt> if @a error is set. Free
   ...
   * @return A DBusConnection or <tt>0</tt> if @a error is set. Free with
   * Glib::object_unref().
   */
   ...
   * @return A locked DBusMessage or <tt>0</tt> if @a error is set.
   */
   ...
   * @newin{2,26}
   * 
   * @return A Credentials or <tt>0</tt> if not available.
   * Do not free this object, it is owned by @a connection.
   */
   ...
   * @newin{2,30}
   * 
   * @param bus_name A unique or well-known bus name or <tt>0</tt>
   * if @a connection is not a message bus connection.
   * @param object_path Path of remote object.
   * @param interface_name D-Bus interface to invoke method on.
   * @param method_name The name of the method to invoke.
   * @param parameters A Variant tuple with parameters for
   * the method or <tt>0</tt> if not passing parameters.
   * @param reply_type The expected type of the reply, or <tt>0</tt>.
...
/** A boolean specifying whether the process will be terminated (by
  ...
  /** The unique name as assigned by the message bus or <tt>0</tt> if the
