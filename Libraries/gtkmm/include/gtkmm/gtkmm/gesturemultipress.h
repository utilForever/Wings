...
public:
  typedef GestureMultiPress CppObjectType;
  typedef GestureMultiPress_Class CppClassType;
  typedef GtkGestureMultiPress BaseObjectType;
  typedef GtkGestureMultiPressClass BaseClassType;
...
private:
  // noncopyable
  GestureMultiPress(const GestureMultiPress&);
  GestureMultiPress& operator=(const GestureMultiPress&);
...
public:
  ...
  /** If @a rect is non-<tt>0</tt>, the press area will be checked to be
   * confined within the rectangle, otherwise the button count
   * will be reset so the press is seen as being the first one.
   * If @a rect is #<tt>0</tt>, the area will be reset to an unrestricted
   * state.
   * 
  ...
  Glib::SignalProxy3< void,int,double,double > signal_pressed();
  ...
  Glib::SignalProxy3< void,int,double,double > signal_released();
  ...
  Glib::SignalProxy0< void > signal_stopped();
