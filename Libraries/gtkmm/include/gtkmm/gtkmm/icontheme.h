 ...
 * is <tt>0</tt> and you need to call Gtk::IconInfo::get_builtin_pixbuf().
 * 
...
public:
   ...
   * containing information about the icon, or <tt>0</tt> if the
   * icon wasn’t found.
   */
   ...
   * information about the icon, or <tt>0</tt> if the icon wasn’t
   ...
   * @newin{3,10}
   * 
   * @param icon_names <tt>0</tt>-terminated
   ...
   * icon wasn’t found.
   */
  IconInfo choose_icon(const std::vector<Glib::ustring>& icon_names, int size, int scale, IconLookupFlags flags);
   ...
   * release your reference to the icon. <tt>0</tt> if the icon isn’t
   * found.
   */
