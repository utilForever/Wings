...
//These are documented as transfer-full, so we don't need to use refreturn.
   ...
   * type, <tt>0</tt> is returned.  <tt>0</tt> is also returned if the attribute
   ...
   * @return The attribute value, or <tt>0</tt>.
   */
   ...
   * 'Quit').
   * 
   * If @a icon is <tt>0</tt> then the icon is unset.
   * 
   * @newin{2,38}
   * 
