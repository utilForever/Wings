...
public:
  ...
  virtual ~MethodInvocation() noexcept;
...
public:
   ...
   * has been redirected to the method call handler then <tt>0</tt> will be
   * returned.  See g_dbus_method_invocation_get_property_info() and
   * DBusInterfaceVTable for more information.
   * 
   * @newin{2,26}
   * 
   * @return A DBusMethodInfo or <tt>0</tt>. Do not free, it is owned by @a invocation.
   */
