...
public:
  ...
  /** Appends @a text to the list of strings stored in @a combo_box.
   * If @a id is non-<tt>0</tt> then it is used as the ID of the row.
   * 
   ...
   * @newin{2,24}
   * 
   * @param id A string ID for this value, or <tt>0</tt>.
   * @param text A string.
   */
   ...
   * 
   * This is the same as calling insert() with a <tt>0</tt>
   * ID string.
   * 
   * @newin{2,24}
   * 
  ...
  /** Inserts @a text at @a position in the list of strings stored in @a combo_box.
   * If @a id is non-<tt>0</tt> then it is used as the ID of the row.  See
  ...
  /** Returns the currently active string in @a combo_box, or <tt>0</tt>
   ...
   * currently active text. Must be freed with Glib::free().
   */
