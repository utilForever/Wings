...
public:
   ...
   * @newin{2,34}
   * 
   * @return The @a proxy's URI, or <tt>0</tt> if unknown.
   */
  ...
  /** The protocol being spoke to the destination host, or <tt>0</tt> if
...
//TODO: This should really be a guint16:
  ...
  /** The URI string that the proxy was constructed from (or <tt>0</tt>
