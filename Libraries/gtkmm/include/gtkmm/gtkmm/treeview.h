...
public:
   ...
   * model is unset.
   * 
   * @return A Gtk::TreeModel, or <tt>0</tt> if
  ...
  /** Sets a hint for the theme to draw even/odd rows in the @a tree_view
   ...
   * Deprecated: 3.14
   * 
   * @deprecated Don't use this API. There is no replacement.
   * 
   ...
   * @deprecated Don't use this API. There is no replacement.
   * 
   * @return <tt>true</tt> if the hint is set.
   */
  ...
  */
   ...
   * these changes by connecting to the model’s Gtk::TreeModel::signal_row_inserted()
   * and Gtk::TreeModel::signal_row_deleted() signals. The reordering is implemented
