...
class FlowBox_Class : public Glib::Class
{
public:
...
protected:
  ...
  static void child_activated_callback(GtkFlowBox* self, GtkFlowBoxChild* p0);
  static void selected_children_changed_callback(GtkFlowBox* self);
