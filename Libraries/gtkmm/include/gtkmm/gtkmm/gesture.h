...
public:
  typedef Gesture CppObjectType;
  typedef Gesture_Class CppClassType;
  typedef GtkGesture BaseObjectType;
  typedef GtkGestureClass BaseClassType;
...
private:
  ...
  Gesture& operator=(const Gesture&);
...
public:
   ...
   * on @a gesture, or <tt>0</tt> if the gesture is not being interacted.
   * 
   * @newin{3,14}
   * 
   * @return A Gdk::Device, or <tt>0</tt>.
   */
   ...
   * @newin{3,14}
   * 
   * @param sequence A Gdk::EventSequence, or <tt>0</tt> for pointer events.
   ...
   * @newin{3,14}
   * 
   * @return The user defined window, or <tt>0</tt> if none.
   */
   ...
   * @newin{3,14}
   * 
   * @param window A Gdk::Window, or <tt>0</tt>.
   */
   ...
   * 
   * @return The list
   * of Gtk::Gestures, free with Glib::list_free().
   */
