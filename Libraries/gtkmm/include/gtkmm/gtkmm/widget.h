...
/* QUEUE DRAWS */
   ...
   * It must be called after set_allocation() (or after chaning up
...
//TODO: void gtk_widget_remove_tick_callback (GtkWidget *widget,  guint id);
   ...
   * ancestry.
   * 
   * If no action group was found matching @a prefix, then <tt>0</tt> is returned.
   * 
   * @newin{3,16}
   * 
   * @param prefix The “prefix” of the action group.
   * @return A ActionGroup or <tt>0</tt>.
   */
  ...
  /** Retrieves a <tt>0</tt>-terminated array of strings containing the prefixes of
