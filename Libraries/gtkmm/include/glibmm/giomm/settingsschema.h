...
class SettingsSchema final
{
  public:
#ifndef DOXYGEN_SHOULD_SKIP_THIS
  typedef SettingsSchema CppObjectType;
  typedef GSettingsSchema BaseObjectType;
...
public:
  ...
  /** Gets the path associated with @a schema, or <tt>0</tt>.
   * 
   ...
   * relocatable schemas, this function will return <tt>0</tt>.
   * 
   * @newin{2,32}
   * 
   * @return The path of the schema, or <tt>0</tt>.
   */
