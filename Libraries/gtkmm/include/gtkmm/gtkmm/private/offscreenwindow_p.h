...
#ifndef _GTKMM_OFFSCREENWINDOW_P_H
#define _GTKMM_OFFSCREENWINDOW_P_H
...
class OffscreenWindow_Class : public Glib::Class
{
public:
...
#endif /* _GTKMM_OFFSCREENWINDOW_P_H */
