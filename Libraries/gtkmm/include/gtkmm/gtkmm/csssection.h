...
class CssSection
{
  public:
#ifndef DOXYGEN_SHOULD_SKIP_THIS
  typedef CssSection CppObjectType;
  typedef GtkCssSection BaseObjectType;
#endif /* DOXYGEN_SHOULD_SKIP_THIS */
...
private:
  // noncopyable
  CssSection(const CssSection&);
  CssSection& operator=(const CssSection&);
...
public:
   ...
   * type Gtk::CSS_SECTION_DOCUMENT. Their parent will either be <tt>0</tt>
   ...
   * @newin{3,2}
   * 
   * @return The parent section or <tt>0</tt> if none.
   */
   ...
   *  @a Gtk::CssProvider::load_from_data(), then <tt>0</tt> is returned.
   * 
   * @newin{3,2}
   * 
   * @return The File that @a section was parsed from
   * or <tt>0</tt> if @a section was parsed from other data.
   */
