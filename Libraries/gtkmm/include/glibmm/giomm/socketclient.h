...
/** The proxy resolver to use
   ...
   * in DNS. @a connection will be <tt>0</tt>.
   * 
   * - SOCKET_CLIENT_RESOLVED:  @a client has successfully resolved
   *  @a connectable in DNS. @a connection will be <tt>0</tt>.
   * 
   ...
   * case @a connection is <tt>0</tt> and the client is about to return an error).
   * 
