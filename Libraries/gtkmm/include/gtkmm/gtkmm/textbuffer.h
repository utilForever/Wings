...
/* Called to specify atomic user actions, used to implement undo */
 ...
 typedef sigc::slot<guint8*, const Glib::RefPtr<TextBuffer>&, const iterator&, const iterator&, gsize&> SlotSerialize;
  ...
  /** This function serializes the portion of text between @a start
   * and @a end in the rich text format represented by @a format.
   * 
   ...
   */
  guint8* serialize(const Glib::RefPtr<TextBuffer>& content_buffer, const Glib::ustring& format, const iterator& start, const iterator& end, gsize& length);
