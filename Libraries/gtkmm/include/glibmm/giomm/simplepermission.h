...
typedef struct _GSimplePermissionClass GSimplePermissionClass;
...
public:
  typedef SimplePermission CppObjectType;
  typedef SimplePermission_Class CppClassType;
  typedef GSimplePermission BaseObjectType;
  typedef GSimplePermissionClass BaseClassType;
...
public:
  ...
  virtual ~SimplePermission() noexcept;
